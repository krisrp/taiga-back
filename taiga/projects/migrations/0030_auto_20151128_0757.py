...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(default=0, verbose_name='activity last month'),
        ),
        migrations.AddField(
            model_name='project',
            name='total_activity_last_week',
            field=models.PositiveIntegerField(default=0, verbose_name='activity last week'),
        ),
        migrations.AddField(
            model_name='project',
            name='total_activity_last_year',
            field=models.PositiveIntegerField(default=0, verbose_name='activity last year'),
        ),
        migrations.AddField(
            model_name='project',
            name='total_fans',
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(default=0, verbose_name='fans last month'),
        ),
        migrations.AddField(
            model_name='project',
            name='total_fans_last_week',
            field=models.PositiveIntegerField(default=0, verbose_name='fans last week'),
        ),
        migrations.AddField(
            model_name='project',
            name='total_fans_last_year',
            field=models.PositiveIntegerField(default=0, verbose_name='fans last year'),
        ),
        migrations.AddField(
            model_name='project',
            name='totals_updated_datetime',
            field=models.DateTimeField(default=datetime.datetime(2015, 11, 28, 7, 57, 11, 743976, tzinfo=utc), auto_now_add=True, verbose_name='updated date time'),
